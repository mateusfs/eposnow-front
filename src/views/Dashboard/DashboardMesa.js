        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="success" stats icon>
              ...
              <p className={classes.cardCategory}>Preço atual</p>
              <h3 className={classes.cardTitle}>R$ 34,24</h3>
            </CardHeader>
            <CardFooter stats>
              <div className={classes.stats}>
                <DateRange />
                Preço atual da comanda
              </div>
            </CardFooter>
          </Card>
        </GridItem>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            ...
            <CardFooter stats>
              <div className={classes.stats}>
                <Accessibility />
                Quantidades de clientes na mesa
              </div>
            </CardFooter>
          </Card>
        </GridItem>
        ...
        <Card>
          <CardHeader color="info">
            ...
            <p className={classes.cardCategoryWhite}>
              Adicionar ou remover um produto da comanda
            </p>
          </CardHeader>
          <Tasks
            checkedIndexes={[0, 3]}
